...
function expectedAccountAddresses(expected) {
  try {
...
function verifyOrderAccounts(order, values) {
  try {
...
function verifyExpectedAccounts(expected, addresses, rpcAccountValues) {
  try {
    const kind = classify(expected);
...
return { expectedAccountAddresses, verifyOrderAccounts, verifyExpectedAccounts };
}
