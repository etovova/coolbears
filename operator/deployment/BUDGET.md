...
Создание коллекции, guard и машины не добавляет отдельную Core asset create fee. Authority PDA машины не создаётся как отдельный rent account. Канонический план не содержит ComputeBudget, tips или оплаты публичного минта. Цена продажи 0,2 SOL и роялти 7% не являются расходом автора на загрузку машины. Выпуск оставшихся 9999 NFT покупателями, раскрытие, хостинг, хранение, домен, RPC-подписки и курс SOL находятся вне этой оценки.
