...
API-ключ не запрашивался через формы и не использовался; торговые операции не отправлялись. Прочитаны указанные страницы и индекс документации, а не весь сайт Magic Eden. Devnet индексирование нового NFT остаётся отдельным практическим этапом.
