...
execFileSync('git', ['diff', '--exit-code', '--', 'solana-test/sdk.js', 'solana-test/sdk.js.LEGAL.txt', 'wallet-standard.js', 'wallet-standard.js.LEGAL.txt', 'solana-upload/sdk.js', 'solana-upload/sdk.js.LEGAL.txt'], { stdio: 'pipe' });
