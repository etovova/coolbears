...
await build({ entryPoints: ['solana/load-client.mjs'], bundle: true, format: 'esm', platform: 'browser', target: ['es2022'], minify: true, outfile: 'solana-load/sdk.js', legalComments: 'external' });
