...
for(const key of ['status','packageSha256','appliesToCurrentCandidate','manifestSha256','carSha256','finalContentCommitment','approvedLogoSha256','approvedBannerSha256','unchangedPngFiles','unchangedMetadataFiles','previousCarExactlyReproduced','actualRevealTvmVerified'])test('Incomplete final branding proof '+key,()=>{const s=clone(prepared);s.evidence.finalCollectionBranding[key]=null;assert.throws(()=>validateLaunch(cfg,p,s,PACKAGE_SHA256));});
