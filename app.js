(() => {
  ...
  const tr = {
    ...
    zh: {
      ...
      beforeReveal:'揭晓之前', revealKicker:'先保持神秘', revealTitle:'你的熊<br>还在隐藏。', revealText:'铸造后，每个 NFT 都显示官方 CoolBears GIF。属性和稀有度保持隐藏，但 NFT 已可出售、转移或赠送。', revealLabel:'揭晓', revealDate:'2027 年 1 月 1 日', revealFoot:'从 2027 年 1 月 1 日 00:00 UTC 起可执行揭晓。揭晓交易完成后，同一个 NFT 显示最终图像和属性，不会重新随机。',
