(() => {
  ...
  const tr = {
    ...
    zh: {
      ...
      faqTitle:'快速<br>解答。', faq1q:'揭晓前可以出售 NFT 吗？', faq1a:'可以。NFT 铸造后即可转移和交易。揭晓前所有人看到同一个 GIF。', faq2q:'什么时候显示属性？', faq2a:'揭晓交易完成后，最早为 2027 年 1 月 1 日。', faq3q:'在哪里交易？', faq3a:'Getgems 完成系列索引后即可在那里上架和交易。正式链接将在部署后添加。', faq4q:'稀有度如何计算？', faq4a:'根据全部 10,000 个 CoolBears 中每个最终属性的真实出现频率计算。',
