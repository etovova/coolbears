(() => {
  ...
  const tr = {
    en: {
      ...
      heroText:'Mint is not open yet. The NFT price will be 7 GRAM (TON), plus creation costs and network fees. Reveal is planned for January 1, 2027.',
      mintNow:'MINT COMING SOON', viewGetgems:'VIEW ON GETGEMS', statPrice:'Mint price', statSupply:'Total supply', statRoyalty:'Royalty', statTx:'Per transaction',
      ...
      mintKicker:'PRIMARY MINT', mintTitle:'MINT IS<br>COMING SOON', mintText:'Choose between 1 and 50 NFTs. There is no lifetime wallet limit. Each NFT costs 7 GRAM (TON).',
      mintNoteLine:'NFTs are tradable immediately after mint.', mintedLabel:'MINT STATUS', quantity:'QUANTITY', total:'NFT PRICE', connectToMint:'CONNECT WALLET TO MINT', mintN:'MINT {n} NFT', mintFoot:'Up to 50 per transaction • no wallet limit',
      ...
      revealLabel:'REVEAL', revealDate:'JANUARY 1, 2027', revealFoot:'Reveal becomes available on January 1, 2027 at 00:00 UTC. After the reveal transaction, the same NFT shows its final artwork and traits. No reroll.',
    ...
    ru: {
      ...
      heroText:'Минт ещё не открыт. Цена NFT составит 7 GRAM (TON), плюс расходы на создание и комиссия сети. Раскрытие запланировано на 1 января 2027 года.',
      mintNow:'МИНТ СКОРО', viewGetgems:'СМОТРЕТЬ НА GETGEMS', statPrice:'Цена минта', statSupply:'Всего', statRoyalty:'Роялти', statTx:'За транзакцию',
      ...
      mintKicker:'ПЕРВИЧНЫЙ МИНТ', mintTitle:'МИНТ<br>СКОРО', mintText:'Выбери от 1 до 50 NFT за одну транзакцию. Общего лимита на кошелёк нет. Цена одного NFT — 7 GRAM (TON).',
      mintNoteLine:'NFT можно перепродавать сразу после минта.', mintedLabel:'СТАТУС МИНТА', quantity:'КОЛИЧЕСТВО', total:'СТОИМОСТЬ NFT', connectToMint:'ПОДКЛЮЧИТЬ КОШЕЛЁК', mintN:'ЗАМИНТИТЬ {n} NFT', mintFoot:'До 50 за транзакцию • без лимита на кошелёк',
      ...
      revealLabel:'РАСКРЫТИЕ', revealDate:'1 ЯНВАРЯ 2027', revealFoot:'Раскрытие разрешено с 1 января 2027 года, 00:00 UTC. После операции раскрытия тот же NFT покажет финального медведя и его атрибуты. Без повторного выбора.',
    ...
    zh: {
      ...
      mintKicker:'首次铸造', mintTitle:'铸造<br>即将开放', mintText:'每次可选择 1–50 个 NFT。钱包没有总数量限制。每个 NFT 价格为 7 GRAM (TON)。',
      mintNoteLine:'NFT 铸造后即可立即交易。', mintedLabel:'铸造状态', quantity:'数量', total:'NFT 价格', connectToMint:'连接钱包开始铸造', mintN:'铸造 {n} 个 NFT', mintFoot:'每笔最多 50 个 • 钱包无总量限制',
      ...
      creatorReserve:'按本系列稀有度评分排名第一的 CoolBear 为创作者预留，不参与公开铸造。其图像和属性在揭晓前保持隐藏。', revealLabel:'揭晓', revealDate:'2027 年 1 月 1 日', revealFoot:'从 2027 年 1 月 1 日 00:00 UTC 起可执行揭晓。揭晓交易完成后，同一个 NFT 显示最终图像和属性，不会重新随机。',
