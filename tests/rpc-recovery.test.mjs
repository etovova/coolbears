...
test('Actual Umi/web3 client reads with two RPC calls and retains saved missing addresses',async()=>{
 ...
 assert.deepEqual(requests.map(r=>r.method),['getGenesisHash','getAccountInfo']);
